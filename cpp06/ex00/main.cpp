...
/*   Updated: 2023/01/02 20:57:32 by zel-hach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void convert_float(int f)
{
	...
	if (static_cast<int>(f)%2 == 0)
		std ::cout <<"float :"  << std::setprecision(1) << std::fixed << static_cast<double>(f) << "f"<< std::endl;
	else 
		std ::cout <<"double :" << static_cast<double>(f) << std::endl;
}
void convert_double(int d)
{
	if (isprint(d))
	...
	std ::cout <<"int :" << static_cast<int>(d) << std::endl;
		...
		std ::cout <<"float :"  << std::setprecision(1) << std::fixed << static_cast<float>(d) << std::endl;
	else 
		std ::cout <<"float :" << d << "f"<< std::endl;
	if (static_cast<int>(d)%2 == 0)
		std ::cout <<"float :"  << std::setprecision(1) << std::fixed << d << std::endl;
	else 
...
int main(int argc, char **argv)
{
	...
	std::cout << "number of arguments greater than 2" << std::endl;
}